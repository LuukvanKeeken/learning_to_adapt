...
import random
import gym
from learning_to_adapt.dynamics.core.layers import MLP, RNN
...
class MetaMLPDynamicsModel(Serializable):
    ...
    def __init__(self,
        ...
        self._adapted_hidden_activations = None
        ...
        with tf.variable_scope(name):
            ...
            self.delta_pred = rnn.output_var  # shape: (batch_size, ndim_obs, n_models)
